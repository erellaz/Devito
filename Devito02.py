...
model = Model(vp=v, origin=origin, shape=shape, spacing=spacing,
              space_order=10, nbl=100, bcs="damp")
...
rec = Receiver(name='rec', grid=model.grid, npoint=1001, time_range=time_range)

# Prescribe even spacing for receivers along the x-axis
rec.coordinates.data[:, 0] = np.linspace(0, model.domain_size[0], num=1001)
